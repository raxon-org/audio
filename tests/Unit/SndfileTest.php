...
beforeEach(function () {
    ...
    $this->testAudioPath = loadTestAudioPath('jfk');
    $this->outputAudioPath = loadTestAudioPath('output');
});
...
it('can open a sound file', function () {
    ...
    $sndfile = Sndfile::open($this->testAudioPath, Sndfile::enum('SFM_READ'), \FFI::addr($sfinfo));
...
it('can write frames to a sound file', function () {
    ...
    $sndfile = Sndfile::open($this->outputAudioPath, Sndfile::enum('SFM_WRITE'), \FFI::addr($sfinfo));
